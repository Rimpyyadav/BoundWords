...
function Navbar() {
   ...
   <li><a>About</a></li>
    ...
    return (
        ...
        <div className = {`max-w-screen-2x1 container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
          sticky? "sticky-navbar shadow-transparent-md bg-base-200 duration-300 transition-all ease-in-out"
          : ""
        }`}>
  ...
  <input type="text" className="grow outline-nonecdark:bg-slate-900 dark:text-white" placeholder="Search" />
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 16 16"
    fill="currentColor"
