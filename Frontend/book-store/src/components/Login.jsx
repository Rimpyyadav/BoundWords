  ...
  <div className="modal-box">
    ...
    <div className="mt-4 space-y-2" >
        ...
        <input type="email"
         ...
         />
         {errors.email && (<span className="text-sm text-red-color" >This field is required</span>)}
    </div>
    ...
    <div className="flex justify-around mt-4">
      ...
      {errors.password && (<span className="text-sm text-red-color" >This field is required</span>)}
    </div>
  </div>
</dialog>
